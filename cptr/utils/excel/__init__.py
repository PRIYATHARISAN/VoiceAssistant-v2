...
EXCEL_TOOLS: dict[str, dict] = {
    ...
    "excel_create_sheet": {"fn": excel_create_sheet},
    "excel_delete_sheet": {"fn": excel_delete_sheet},
    "excel_rename_sheet": {"fn": excel_rename_sheet},
    "excel_get_sheet_info": {"fn": excel_get_sheet_info, "approval": "allow"},
    "excel_read_range": {"fn": excel_read_range, "approval": "allow"},
    "excel_write_range": {"fn": excel_write_range},
    "excel_update_cell": {"fn": excel_update_cell},
    "excel_append_rows": {"fn": excel_append_rows},
    "excel_clear_range": {"fn": excel_clear_range},
    "excel_search_sheet": {"fn": excel_search_sheet, "approval": "allow"},
    "excel_sort_range": {"fn": excel_sort_range},
    "excel_filter_range": {"fn": excel_filter_range, "approval": "allow"},
    "excel_write_formula": {"fn": excel_write_formula},
    "excel_format_range": {"fn": excel_format_range},
    "excel_create_chart": {"fn": excel_create_chart},
}
